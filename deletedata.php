...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>Delete Data</title>
...
<!-- Delete -->
  <div class="w3-container" id="contact">
    ...
    <form name="DeleteData" action="deletedata.php" method="POST">
      ...
      <button type="submit" class="w3-button w3-block w3-padding-large w3-black w3-margin-bottom">Delete</button>
    </form>  
  </div>
